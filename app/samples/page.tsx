export default function SamplesPage() {
  return (
    <section style={{ padding: '64px var(--content-pad)', maxWidth: 'var(--content-max)', margin: '0 auto' }}>
      <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: '.14em', textTransform: 'uppercase', color: 'rgba(166,183,210,.6)', marginBottom: 16 }}>Research Samples</div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16 }}>
        ...
        <a href="/redcanary" style={{ display:'flex', flexDirection:'column', background:'rgba(255,255,255,.03)', border:'1px solid rgba(255,255,255,.1)', padding:'28px 32px', textDecoration:'none', minHeight:220 }}>
          <div style={{ fontSize:10, fontWeight:700, letterSpacing:'.12em', textTransform:'uppercase', color:'rgba(166,183,210,.6)', marginBottom:14 }}>SENTINEL &middot; Cybersecurity MDR</div>
          <div style={{ flex:1, display:'flex', alignItems:'center' }}>
            <img src="/red-canary-logo.svg" alt="Red Canary" style={{ height:28, width:'auto', maxWidth:200 }} />
          </div>
          <div style={{ fontSize:12, fontWeight:600, color:'rgba(166,183,210,.8)', marginTop:16 }}>View Study &rarr;</div>
        </a>
        ...
        <a href="/bluecat" style={{ display:'flex', flexDirection:'column', background:'rgba(255,255,255,.03)', border:'1px solid rgba(255,255,255,.1)', padding:'28px 32px', textDecoration:'none', minHeight:220 }}>
          <div style={{ fontSize:10, fontWeight:700, letterSpacing:'.12em', textTransform:'uppercase', color:'rgba(166,183,210,.6)', marginBottom:14 }}>FORTRESS &middot; Network Infrastructure</div>
          <div style={{ flex:1, display:'flex', alignItems:'center' }}>
        ...
        >
          <div style={{ fontSize:10, fontWeight:700, letterSpacing:'.12em', textTransform:'uppercase', color:'rgba(166,183,210,.6)', marginBottom:14 }}>
          ...
          <div style={{ fontSize:12, fontWeight:600, color:'rgba(166,183,210,.8)', marginTop:16 }}>Read Report &rarr;</div>
        </a>
