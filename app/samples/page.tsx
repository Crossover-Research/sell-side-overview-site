  ...
  return (
    <section style={{ padding: '64px var(--content-pad)', maxWidth: 'var(--content-max)', margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16 }}>
        ...
        {/* Conservice VoC report. repo-hosted PDF */}        <a href="/conservice" style={{ display:'flex', flexDirection:'column', background:'rgba(255,255,255,.03)', border:'1px solid rgba(255,255,255,.1)', padding:'28px 32px', textDecoration:'none', minHeight:220 }}><div style={{ fontSize:12, fontWeight:700, letterSpacing:'.12em', textTransform:'uppercase', color:'rgba(166,183,210,.85)', marginBottom:14 }}>Conservice &middot; Utility Management Software</div><div style={{ flex:1, display:'flex', alignItems:'center' }}><img src="/conservice-logo-white.png" alt="Conservice" style={{ height:34, width:'auto', maxWidth:210 }} /></div><div style={{ fontSize:15, fontWeight:600, color:'rgba(166,183,210,.8)', marginTop:16 }}>View Study &rarr;</div></a>
        <a
