        ...
        <div style={{ maxWidth:1140,margin:'0 auto' }}>
          <div style={{ display:'grid',gridTemplateColumns:'1fr 400px',gap:48,alignItems:'start' }}>
            ...
            <div style={{ background:'rgba(255,255,255,.04)',border:'1px solid rgba(255,255,255,.1)',padding:'22px 24px',position:'relative',overflow:'hidden' }}>
              ...
              <p style={{ fontSize:12.5,color:'rgba(255,255,255,.72)',lineHeight:1.65,marginBottom:14 }}>J.P. Morgan commissioned Crossover to win the Nerdio Series C mandate. Brad read the customer findings and wrote an original investment thesis on Nerdio — the same discipline as public equity stockpicking applied to private markets. He pitched that thesis to a select handful of PE funds.</p>
              <p style={{ fontSize:12.5,color:'rgba(255,255,255,.72)',lineHeight:1.65,marginBottom:14 }}>General Atlantic took a 30-minute call. The mandate deck findings briefed them on a fully-formed thesis in a single meeting. They then commissioned Crossover to run the secondary diligence stream to validate the initial findings. <strong style={{ color:'#fff' }}>$500M Series C. $1B+ valuation.</strong></p>
              <div style={{ borderTop:'1px solid rgba(255,255,255,.08)',paddingTop:10,fontSize:11,color:'rgba(255,255,255,.35)',fontStyle:'italic' }}>Sell-side mandate research became an original thesis. That thesis became a 30-minute conviction brief. That brief became a secondary diligence commission. That diligence became a $500M deal. One research infrastructure. The full transaction lifecycle.</div>
            </div>
          </div>
          {/* Stats */}
