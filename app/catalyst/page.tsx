        ...
        <div style={{ maxWidth:1140,margin:'0 auto' }}>
          <div style={{ display:'grid',gridTemplateColumns:'1fr 400px',gap:48,alignItems:'start' }}>
            ...
            <div style={{ background:'rgba(255,255,255,.04)',border:'1px solid rgba(255,255,255,.1)',padding:'22px 24px',position:'relative',overflow:'hidden' }}>
              ...
              <p style={{ fontSize:12.5,color:'rgba(255,255,255,.72)',lineHeight:1.65,marginBottom:14 }}>J.P. Morgan engaged Crossover to win the Nerdio Series C mandate. That sell-side engagement gave Crossover line of sight into an asset the PE market hadn't yet evaluated. We formed a view from the primary research: high-conviction fundamental story. We alerted select funds that fit the asset's thesis profile.</p>
              <p style={{ fontSize:12.5,color:'rgba(255,255,255,.72)',lineHeight:1.65,marginBottom:14 }}>General Atlantic took a 30-minute call. The mandate research briefed them on a fully-formed thesis in a single meeting — early positioning before the formal process began. They commissioned Crossover for secondary diligence to validate the initial findings. The diligence held. <strong style={{ color:'#fff' }}>$500M Series C at $1B+ valuation.</strong></p>
