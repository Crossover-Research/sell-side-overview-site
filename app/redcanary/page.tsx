        ...
        {active === 'vendor' && (
          <div className="rc-section">
            ...
            <div className="charts-grid">
              <div className="chart-card"><div className="chart-card-title">Likelihood to Recommend</div><NpsChart labels={NPS_CHART_DATA.labels} data={NPS_CHART_DATA.data} /></div>
              <div className="chart-card"><div className="chart-card-title">Replication Difficulty</div><RepChart labels={REP_CHART_DATA.labels} data={REP_CHART_DATA.data} /></div>
              <div className="chart-card"><div className="chart-card-title">Cost vs. In-House SOC</div><CostChart labels={COST_CHART_DATA.labels} data={COST_CHART_DATA.data} colors={COST_CHART_DATA.colors} /></div>
              <div className="chart-card"><div className="chart-card-title">Why Customers Adopted MDR</div><DriversChart labels={ADOPTION_DRIVERS_DATA.labels} redCanaryData={ADOPTION_DRIVERS_DATA.redCanaryData} avgData={ADOPTION_DRIVERS_DATA.avgData} /></div>
            </div>
            <InsightBox><strong>84% of verified Red Canary customers</strong> report the platform costs less than an equivalent in-house SOC.</InsightBox>
          </div>
        )}
