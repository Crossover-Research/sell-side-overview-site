...
export const IB_CAP_DATA: Record<IBCap, IBCapabilityData> = {
  ...
  mandate: {
    ...
    bankerProblem: 'You are pitching alongside 4 other banks with identical decks. The client has no rational basis to choose you.',
    crossoverAnswer: 'We deliver a pre-engagement intelligence package before your pitch. Independent customer evidence, competitive vulnerabilities, equity story framing — before competing banks finish reading the teaser.',
    stats: [],
    features: [
  ...
  'buyer-mapping': {
    ...
    body: "Most sell-side processes send the same process letter to the same 40 names and wait. Crossover builds a scored buyer landscape before the first outreach — strategic acquirers mapped against competitive synergy, financial buyers scored on mandate fit and fund dynamics. You know which buyers will bid at the highest conviction before you prioritize management's time.",
  ...
  'operator-rebuttal': {
    ...
    body: "Every asset has weaknesses. Most operators and bankers know this — and most hide them below the surface because there hasn't been an affordable, fast mechanism to formulate a response plan during a transaction sprint. The reflex is to hope buyers don't find the gaps before you close. Crossover inverts this. We surface gaps on purpose — using independent respondents who weren't handpicked by management — then help operators build customer-backed evidence to close them before the formal process begins. Proactive, not reactive. Evidence-based, not management-asserted. This is our most defensible capability because it's the only one that makes the research more credible by finding problems.",
    ...
    stats: [],
    features: [
      { title: 'Independent Gap Assessment', desc: "Respondents sourced entirely from public signals — no management reference list, no handpicked advocates. The findings reflect what the full customer base actually experiences, including friction, complaints, and risk flags buyers will surface. We don't sanitize what we find." },
  ...
  'ai-mgmt': {
    ...
    stats: [],
    features: [
      { title: 'Fund-Specific IC Simulation', desc: "For any named acquirer, five personas grounded in the fund's actual thesis, portfolio, and deal history. Which dimensions they'll interrogate, what evidence they demand, where they'll walk — built from primary research on the buyer, not generic PE archetypes." },
      { title: 'Interactive Adversarial Mode', desc: 'Management plays themselves. The engine plays the buyer IC panel — every blocking objection turned into a live question. The session produces a readiness score by topic and a prioritized prep list.' },
  ...
  cortex: {
    ...
    bankerProblem: 'Expert networks give you opinions. Management references give you advocates. Analyst reports give you estimates. None of these sources can be used by the other side — which means none resolve the information asymmetry that creates conflict.',
    ...
    features: [
      ...
      { title: 'Queryable Intelligence Portals', desc: 'Every deliverable is a hosted portal with an embedded AI assistant — buyers query in natural language, answers drawn from verified respondent data immediately. No analyst in the loop, no 48-hour turnaround. The research is alive for the duration of the process.' },
