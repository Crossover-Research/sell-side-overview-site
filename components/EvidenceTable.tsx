...
const ROWS: {
  ...
  },
  {
    ...
    withBold: {
      bankers:   '50% sell-side mandate win rate. Not relationship. Evidence.',
...
const OUTCOME: Record<Audience, { stat: string; statLabel: string; desc: string }> = {
  bankers:   { stat:'60%',    statLabel:'Win Rate',  desc:'60% sell-side mandate win rate. Not because of better relationships. Pitches built from what customers actually say.' },
